...
public class AppConfig {
    ...
    @Bean
    public AuthorRepository authorRepository(RepositoryFactorySupport repositoryFactorySupport) {
        return repositoryFactorySupport.getRepository(AuthorRepository.class);
    }

    @Bean
    public BookRepository bookRepository(RepositoryFactorySupport repositoryFactorySupport) {
        return repositoryFactorySupport.getRepository(BookRepository.class);
    }
}
