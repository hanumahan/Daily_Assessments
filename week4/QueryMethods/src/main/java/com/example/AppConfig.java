...
public class AppConfig {
    ...
    @Bean
    public EmployeeRepository employeeRepository(RepositoryFactorySupport repositoryFactorySupport) {
        return repositoryFactorySupport.getRepository(EmployeeRepository.class);
    }
}
